...
<head>
   ...
   <link rel="stylesheet" href="<?php echo $this->webroot?>css/font-awesome.min.css">
    ...
    <!-- Main styles -->
    <link href="<?php echo $this->webroot?>css/index-style.css" rel="stylesheet">
    <!-- Responsive styles -->
...
<body>
    ...
    <header>
        ...
        <nav class="navbar navbar-dark blue darken-1 nav-top">  
            <ul class="flex-list">
                <p class="flex-list flex-list--text">Welcome <span id="name">&nbsp;&nbsp;<?php echo $customer['Customer']['name'];?></span></p>
            </ul>
        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-white nav-margin">
            <a class="navbar-brand" href="#"><h3><strong>ServiceMe</strong></h3></a>
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="<?php echo $this->webroot?>users/logout">Log out</a>
                    </li>
                    <li class="nav-item">
    ...
    <footer class="page-footer blue-grey lighten-5 pt-0">
      ...
      <!--Footer Links-->
        <div class="container mt-5 mb-4 text-center text-md-left">
            <div class="row mt-3">
                ...
                <div class="col-md-3 mb-r dark-grey-text">
                    <h6 class="title font-bold"><strong>ServiceMe</strong></h6>
                    <hr class="teal accent-3 mb-4 mt-0 d-inline-block mx-auto">
                    <p>About ServiceMe here.</p>
                </div>
                <!--/.First column-->
                ...
                <div class="col-md-3 dark-grey-text">
                    ...
                    <p><i class="fa fa-envelope mr-3"></i> info@serviceme.com.ng</p>
        ...
        <div class="footer-copyright">
            <div class="container-fluid">
                © 2018 Copyright: <a href="#"><strong> ServiceMe</strong></a>
            </div>
        </div>
